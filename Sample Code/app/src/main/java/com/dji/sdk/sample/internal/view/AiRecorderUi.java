 ...
 */
public abstract class AiRecorderUi extends LinearLayout implements View.OnClickListener, PresentableView, View.OnTouchListener {
    ...
    public AiRecorderUi(Context context) {
        super(context);
        initUI(context);
    }
    ...
    private void initUI(Context context) {
        ...
        rightBtn.setText("Object Tracking");
